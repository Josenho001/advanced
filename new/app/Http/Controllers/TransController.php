...
class TransController extends Controller
{
    ...
    public function store(Request $request)
    {
     ...
     $meter=$request->input('meter');
        ...
        Session::put('dev', $meter );



     $device = DB::table('meters')->where('meter',$meter)->first();
      if(!$device){
            \Session::flash('msg', '  The Meter Number Does Not Exist.. Please Check Then Try Again' );
            return redirect()->back();
      }
      if($device){
        
//return Session::get('meter'); //outputs this is something in session
          //Session::flash('success', '  Thank you For Purchasing Water Credit.. Your balance Will Be Updated Shortly' );
                  ...
                  */
                  ...
                  $TransactionDesc = 'Water Credit Purchase.';
                  $Amount = $amount;
                  ...
                  # callback url  
                  $CallBackURL = 'http://c356db73.ngrok.io/Callback_url.php';      
