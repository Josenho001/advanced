...
$user = "josenho";
$password = "b4kimoja";
$con = mysqli_connect($server,$user,$password,"watertoken");
// Check connection
if (mysqli_connect_errno())
  ...
  echo "Thanks For Purchasing Water Credit";
  }
  //__________________________________________________________
 
 echo $arr["Body"]["stkCallback"]["ResultCode"] . "<br>";
  if($arr["Body"]["stkCallback"]["ResultCode"]==0){
    $array2 = $arr["Body"]["stkCallback"]["CallbackMetadata"]["Item"];
    $stkresponse = "Response Code: ".$arr["Body"]["stkCallback"]["ResultCode"]."--"."Amount: ".$array2[0]["Value"]."--"."MpesaReceiptNumber: ".$array2[1]["Value"]."--"."TransactionDate: ".$array2[3]["Value"]."--"."PhoneNumber: ".$array2[4]["Value"]."--"."reference: ".$_GET['reference']."</br>";
      
    $sql4 = mysqli_query($con,"INSERT INTO trans (phone,amount,reference) VALUES('".$array2[4]["Value"]."','".$array2[0]["Value"]."', '".$array2[1]["Value"]."')");


            $customer = Session::get('dev' );
            //$customer = $array2[4]["Value"];
            $cash = $array2[0];
            $unit =1;
            $total = $unit*$array2[0]["Value"];
...
//$dev = Session::get('meter');



  $recipients = $customer;

  //$recipients = Session::get('meters');
  $message    = "You have purchased ".$total." Units of Water. Your units balance will be updated shortly";
  $gateway    = new AfricasTalkingGateway("findpata", "cf4b37a8d2c4312b489d4dd877ad20c08df73a3a90c49d4788bc8501e68a9429");
  try 
  {
